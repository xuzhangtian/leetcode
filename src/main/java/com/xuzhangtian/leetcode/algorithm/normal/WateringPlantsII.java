...
public class WateringPlantsII {
    ...
    public static void main(String[] args) {
        System.out.println(minimumRefill(new int[]{726, 739, 934, 116, 643, 648, 473, 984, 482, 85, 850, 806, 146, 764, 156, 66, 186, 339, 985, 237, 662, 552, 800, 78, 617, 933, 481, 652, 796, 594, 151, 82, 183, 241, 525, 221, 951, 732, 799, 483, 368, 354, 776, 175, 974, 187, 913, 842},
                1439, 1207));
    }
